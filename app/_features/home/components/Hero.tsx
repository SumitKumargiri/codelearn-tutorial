...
import { ArrowRight, BookOpen, CheckCircle2, Code2, Rocket, Sparkles, Stars } from "lucide-react";
...
export function Hero() {
  return (
    <section className="relative min-h-[calc(100vh-4rem)] overflow-hidden bg-[#10162F] text-white">
      ...
      <div className="relative mx-auto grid max-w-7xl gap-10 px-4 py-10 sm:px-6 lg:grid-cols-2 lg:items-center lg:px-8 lg:py-12">
        <div className="max-w-xl">
          <div className="mb-5 inline-flex items-center gap-2 rounded-full border border-white/15 bg-white/10 px-4 py-2 text-sm font-medium text-white/90 backdrop-blur-xl">
          ...
          <div className="mt-8 flex flex-col gap-4 sm:flex-row">
            <Link
              href={ROUTES.CATALOG}
              className="group inline-flex items-center justify-center gap-2 rounded-2xl bg-[#FFD300] px-7 py-3.5 font-semibold text-[#10162F] shadow-[0_18px_50px_rgba(255,211,0,0.22)] transition-transform duration-300 hover:-translate-y-0.5"
            >
              Explore Tutorials
            ...
            <Link
              ...
              className="inline-flex items-center justify-center rounded-2xl border border-white/15 bg-white/5 px-7 py-3.5 font-semibold text-white backdrop-blur-xl transition-colors duration-300 hover:bg-white/10"
            >
              View Resources
            </Link>
          </div>
          ...
          <div className="mt-8 grid gap-3 sm:grid-cols-3">
            {features.map((feature) => {
              ...
              return (
                <div
                  key={feature.title}
                  className="rounded-3xl border border-white/10 bg-white/5 p-4 backdrop-blur-xl transition-transform duration-300 hover:-translate-y-1 hover:bg-white/10"
                >
                  <div className="mb-3 inline-flex h-11 w-11 items-center justify-center rounded-2xl bg-white/10">
                    <Icon className="h-5 w-5 text-[#FFD300]" />
                  </div>
              ...
              <div className="mb-4 flex items-center justify-between">
                <div>
                  ...
                  <p className="text-base font-semibold text-white sm:text-lg">
                    Build faster with guided lessons
                  </p>
                </div>

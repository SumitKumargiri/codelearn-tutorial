...
export function Hero() {
  return (
    ...
    //     {/* Left Content */}
    //     <div>
    //       <div className="inline-flex items-center px-5 py-2 rounded-xl bg-indigo-100 text-indigo-700 font-semibold mb-8">
    //         Learn. Code. Grow.
    //       </div>
    ...
    //      <ImageWithFallback
    //         src="https://files.oaiusercontent.com/file_00000000e754720bab8388ecc3074b79"
    //         alt="CodeLearn Hero"
    //         width={850}
    //         height={700}
    //         // priority
